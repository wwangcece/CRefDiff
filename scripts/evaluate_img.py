...
import torch
from img_utils import util_image
import tqdm
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--in_path",
        type=str,
        default="./results/test-ours-final-abla-query/samples",
    )
    parser.add_argument(
        "-r",
        "--ref_path",
        type=str,
        default="/mnt/massive/wangce/RefSR_x10/dataset/All_2/test/HR",
    )
    parser.add_argument(
        "-o",
        "--out_path",
        type=str,
        default="./logs-new/ours_v2_abla_query",
    )
